...
//
// The parent layout already ran the auth + role check and renders the
// shared site header for the whole /doctor subtree, so this layout renders
// {children} only — rendering the header again would duplicate the nav.
