...
- [ ] 03-01-PLAN.md — `doctor_search_view` migration, blocking push, and anon-client RLS/grant proof
- [ ] 03-02-PLAN.md — Demo availability slots (idempotent seed) plus the shared `lib/timezone.ts` extraction

**Wave 2** *(blocked on Wave 1 completion)*

- [ ] 03-03-PLAN.md — Tracer: end-to-end name search at `/search` with result card, states and sort contract
- [ ] 03-04-PLAN.md — Public doctor profile page and endpoint, demo badge, grouped slots, inert booking CTA

**Wave 3** *(blocked on Wave 2 completion)*

- [ ] 03-05-PLAN.md — Specialty, language, neighborhood and availability-range filters combined with AND

**Wave 4** *(blocked on Wave 3 completion)*

- [ ] 03-06-PLAN.md — Numbered pagination, total count, and cross-page sort stability
...
| 3. Doctor Discovery — Search & Public Profiles | 0/6 | Planned     | - |
